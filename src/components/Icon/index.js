export const IconSendMessage = ({ width = '26px', height = '26px', color = 'black' }) => {
  return (
    <svg width={width} data-e2e="" height={height} viewBox="0 0 48 48" fill={color} xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
export const IconInbox = ({ width = '32px', height = '32px', color = 'black' }) => {
  return (
    <svg width={width} data-e2e="" height={height} viewBox="0 0 32 32" fill={color} xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
export const IconEffects = ({ width = '22px', height = '22px' }) => {
  return (
    <svg
